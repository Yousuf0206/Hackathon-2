"""
Dapr Pub/Sub publish helper for reminder events.
...
async def publish_event(
    ...
    Args:
        event_type: CloudEvents type string (e.g., com.todo.reminder.triggered.v1)
        source: Originating service name (e.g., notification-service)
